...
private:
    ...
    void initVulkan()
    {
        ...
        QueueFamilyIndices activeQueuesIndices = VulkanUtilities::getGraphicsQueueFamilyIndex(physicalDevice, surface);
        ...
        vkGetDeviceQueue(device, activeQueuesIndices.graphicsFamily.value(), 0, &graphicsQueue);
        vkGetDeviceQueue(device, activeQueuesIndices.presentFamily.value(), 0, &presentQueue);
    ...
    std::vector<const char *> getRequiredExtensions()
    {
        ...
        // using vector's range constuctor
    ...
    void createSwapChain()
    {
        ...
        QueueFamilyIndices indices = VulkanUtilities::getGraphicsQueueFamilyIndex(physicalDevice, surface);
    ...
    void createRenderPass()
    {
        ...
        // I need to include depth attachment to a render pass
    ...
    void createGraphicsPipeline()
    {
        ...
        auto bindingDescription = VulkanUtilities::Vertex::getBindingDescription();
        auto attributeDescriptions = VulkanUtilities::Vertex::getAttributeDescriptions();
    ...
    void drawFrame()
    {
        ...
        // Wait for image to write colors to image
        ...
        // Bind to semaphore to signal render finish
        ...
        // Submit the rendered image back to the swap chain
        VkPresentInfoKHR presentInfo = {};
        presentInfo.sType = VK_STRUCTURE_TYPE_PRESENT_INFO_KHR;

        // A semaphore to wait for
    ...
    void cleanupSwapchain()
    {
        ...
        // Freeing command buffers allows to reuse existing command pool
...
int main()
{
    std::cout << "Debug: " << enableValidationLayers << std::endl;
